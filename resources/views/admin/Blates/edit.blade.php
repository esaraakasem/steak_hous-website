            ...
            <!--/.col-->
                ...
                <div class="col-lg-6">
                    <div class="card-body card-block">
                        {!!Form::model($blate,['route' => ['Blates.update',$blate->id] , 'method' => 'PATCH','files' => true]) !!}


                        <div class="form-group"><label for="company" class=" form-control-label">Name : </label> {!! Form::text("Name",null,['class'=>'form-control','placeholder'=>'Enter Name'])!!} </div>
                        ...
                        <div class="row form-group">
                            <div class="col-8">
                                <div class="form-group"><label for="city" class=" form-control-label">Price:</label>{!! Form::text("price",null,['class'=>'form-control'])!!}</div>
                            </div>
                            <div class="col-8">
                                <div class="form-group"><label for="postal-code" class=" form-control-label">  Description : </label> {!! Form::textarea("description",null,['class'=>'form-control'])!!}</div>
                            </div>
                            <div class="col-8">
                                <div class="form-group"><div><label for="postal-code" class=" form-control-label">  File : </label>{!! Form::file("file",null,['class'=>'form-control'])!!}</div>
                    ...
                    <button id="delete" type="reset" class="btn btn-danger btn-sm">
