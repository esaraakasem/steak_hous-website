            ...
            <!--/.col-->
                ...
                <div class="col-lg-6">
                    <div class="card-body card-block">
                        {!!Form::model($chief,['route' => ['chiefs.update',$chief->id] , 'method' => 'PATCH','files' => true]) !!}
                       ...
                       <div class="row form-group">
                            <div class="col-8">
                                <div class="form-group"><label for="city" class=" form-control-label">salary:</label>{!! Form::text("salary",null,['class'=>'form-control'])!!}</div>
                            </div>
